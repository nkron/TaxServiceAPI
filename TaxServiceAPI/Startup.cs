    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient("TaxJar", c =>
            {
                ...
                //https://www.aspsnippets.com/Articles/Net-Core-Read-Get-value-from-AppSettingsjson-inside-Startupcs.aspx
                c.BaseAddress = new Uri(Configuration.GetSection("TaxJar")["ApiUrl"]);
